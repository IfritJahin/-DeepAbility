      ...
      <div class="col-md-12 col-lg-10 col-xl-8">
        <div class="card">
          <div class="card-body p-md-5">
            ...
            <label for="pet-select">Choose a course:</label>

            <select name="pets" id="pet-select">
                <option value="">--Please choose an option--</option>
                <option value="dog">Mentally Fit Course</option>
                <option value="cat">Physically Fit Course</option>
                <option value="hamster">Overcome Learning Disability</option>
            </select>
            ...
            <div class="px-3 py-4 border border-primary border-2 rounded mt-4 d-flex justify-content-between">
              <div class="d-flex flex-row align-items-center">
                ...
                <div class="d-flex flex-column ms-4">
                  <span class="h5 mb-1">Mentally Fit Course</span>
                  <span class="small text-muted">BUILD YOUR CONFIDENT</span>
                </div>
              </div>
              <div class="d-flex flex-row align-items-center">
                <sup class="dollar font-weight-bold text-muted">TK</sup>
                <span class="h2 mx-1 mb-0">1,000</span>
            ...
            <div class="px-3 py-4 border border-primary border-2 rounded mt-4 d-flex justify-content-between">
              <div class="d-flex flex-row align-items-center">
                <img src="https://i.imgur.com/S17BrTx.webp" class="rounded" width="60" />
                <div class="d-flex flex-column ms-4">
                  <span class="h5 mb-1">Physically Fit Course</span>
                  <span class="small text-muted">BUILD YOUR CONFIDENT</span>
                </div>
              </div>
              <div class="d-flex flex-row align-items-center">
            ...
            <div class="px-3 py-4 border border-primary border-2 rounded mt-4 d-flex justify-content-between">
              <div class="d-flex flex-row align-items-center">
                <img src="https://i.imgur.com/S17BrTx.webp" class="rounded" width="60" />
                <div class="d-flex flex-column ms-4">
                  <span class="h5 mb-1">Overcome Learning Disability</span>
                  <span class="small text-muted">BUILD YOUR CONFIDENT</span>
                </div>
              </div>
              <div class="d-flex flex-row align-items-center">
