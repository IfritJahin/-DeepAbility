      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <h4 class="font-weight-bolder text-info text-white">Admin Register</h4>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form text-left" method="POST" action="{{ route('admin.register')}}">
                ...
                <p class="text-sm mt-3 mb-0">Already have an account? <a href="{{ route('admin.login')}}" class="text-dark font-weight-bolder">Sign in</a></p>
              </form>
            </div>
          </div>
        </div>
